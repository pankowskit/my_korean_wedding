...
class WeddingsS4 extends Component{
    render(){
        return(    
            <Container fluid className="weddings-s4 d-flex minh-50vh align-items-center py-5 bg-secondary border-top border-dark">
