...
class MagazineS2 extends Component{
    render(){
        return(    
            <Container fluid className="magazine-s2 bg-secondary d-flex minh-50vh align-items-center py-5">
